...
plot "airy.dat" using 1:2 index 1 w lp ps 0.1 lc rgb "black" title "RK4"
replot "airy.dat" using 1:2 index 2 w lp ps 0.1 lc rgb "red" title "FD"
...
# Plottiamo effettivamente i file di dati
plot "airy.dat" using 1:2 index 0 w lp ps 0.1 lc rgb "blue" title "Residual"